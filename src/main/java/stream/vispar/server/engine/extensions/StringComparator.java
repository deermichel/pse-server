...
/**
 * A siddhi extension that compares two strings. Returns an integer as defined
 * in {@link String#compareTo(String)}. A {@code null} value is treated as first
 * possible value instead of throwing an exception.
 * 
 * @author Jonas
 */
